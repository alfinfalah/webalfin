<ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion shadow" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
        ...
        <div class="sidebar-brand-text mx-3">Kecamatan <sup>doro</sup></div>
    </a>
    ...
    <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item <?=($getsegment == 'fasilitas') ? 'active' : ''; ?>"
                    href="/fasilitas">Fasilitas</a>
                <a class="collapse-item <?=($getsegment == 'admin') ? 'active' : ''; ?>" href="/admin">Admin</a>
                <a class="collapse-item" href="/login/logout">Log
                    out</a>
